import './Histoire.css';
import VoyageTokyo from '../../image/Voyage_tokyo.jpg';
import ConteLune from '../../image/contes_de_la_lune.jpg';
import Orochi from '../../image/orochi.jpg';
import Godzilla from '../../image/godzilla.jpg';
import Kitano from '../../image/kitano.jpg';
  ...
  return (
    <div className='histoire'>
      <main>
        ...
        <h2>Les débuts</h2>
        <p className='texte'>
          Les premiers films, ceux de Thomas Edison qui adopte le mot anglais
        ...
        <h2>Le cinéma muet et les débuts du cinéma parlant</h2>
        <p className='texte'>
          La première star japonaise est un acteur de kabuki, Matsunosuke Onoe,
          qui apparaît dans près d'un millier de films entre 1909 et 1926.
          <br />
          <br /> La première actrice reconnue est la danseuse classique Tokuko
          ...
          japonais de l'univers théâtral. Les films sont encore muets, et les
          cinémas emploient des benshi, qui commentent ou interprètent la
          bande-son des films, parfois accompagnés de musique jouée par un
          orchestre.
          <br />
          <br /> Leur grande popularité explique en partie le retard du Japon à
          passer massivement au cinéma parlant dans la seconde moitié des années
          1930. <br />
          <br />
          ...
          <br />
          <br /> C'est le temps des films « à tendance » qui, sur fond de crise
          économique et sociale, tentent d'illustrer les conséquences négatives
          et contradictions du capitalisme avant que la censure ne mette fin à
          cette ambition critique.
          <br />
          <br /> C'est ce contexte qui favorise l'émergence ou impose une autre
          orientation : libéré des contraintes figées du théâtre, l'intérêt pour
          la vie quotidienne au sein du foyer japonais se développe afin
          ...
          préfecture de Kanagawa, et commencent à promouvoir des stars comme
          Kinuyo Tanaka ou Hiroko Kawasaki. Le 26 février 1936, des officiers
          fomentent un coup d'État qui échoue mais qui symbolise l'essor
        ...
        <h2>Pendant la guerre</h2>
        <p className='texte'>
          Au début de la guerre sino-japonaise, une loi mettant la production
          cinématographique sous contrôle du gouvernement est mise en place le
          1er octobre 1939.
          <br />
          ...
          deux geki eiga (films de fiction) par mois produits par deux
          compagnies seulement, alors que la Nikkatsu, Shōchiku, Tōhō, Shinko et
          Daito présentent alors environ un nouveau film par semaine.
          <br />
          <br /> Les différentes compagnies sont fusionnées en deux compagnies :
          la Shōchiku et la Tōhō. Néanmoins, Masaichi Nagata de Shinkō Kinema
          intervient pour permettre la création en 1942 de ce qui deviendra la
          Daiei.
          <br />
          <br /> Beaucoup de professionnels abandonnent leur emploi. Les jeunes
          employés partent à la guerre. Dans les territoires occupés comme les
          Philippines, l'Indonésie ou la Mandchourie, des films de propagande
          sont tournés11. Kajirō Yamamoto réalise des parodies avec le comique
          Enoken avant de réaliser des films de propagande militaristes dans
          ...
          responsabilités. Le scénario est donc conforme aux idées de l'État
          dans la guerre bien que le scénario ait été écrit en 1937.
          <br />
          <br />
          ...
          meurent dans le bombardement d'Hiroshima.
        </p>
        <h2>L'après-guerre</h2>
        <p className='texte'>
          À la censure japonaise succède la censure imposée par les Américains.
          Akira Kurosawa fait ses débuts comme assistant de Kajirō Yamamoto
          durant la guerre.
          <br />
          ...
          Les Sept Samouraïs (1954) de Kurosawa sont récompensés par un Lion
          d'argent à la Mostra de Venise. Masaki Kobayashi reçoit le Prix du
          jury du Festival de Cannes pour Hara-kiri en 1962.
          <br />
          ...
          produire de nouveau des films. De nouveaux studios Nikkatsu sont
          construits en 1954 dans la banlieue de Tokyo.
          <br />
          ...
          fonds de commerce repose sur la violence et la sexualité débridées de
          héros de type « jeunes rebelles », notamment dans les pinku eiga
          (films érotiques).
        </p>
        <h2>La nouvelle vague</h2>
        <p className='texte'>
          La nouvelle vague japonaise, contrairement à la Nouvelle Vague
          française, ne regroupait pas un groupe de cinéastes autour d'une revue
          ou d'un groupe, mais correspondait au Japon à un terme utilisé par les
          critiques pour évoquer des cinéastes « rebelles » de la Shōchiku :
          Nagisa Ōshima, Yoshishige Yoshida et Masahiro Shinoda et en référence
          à la Nouvelle Vague française.
          <br />
          <br /> Les trois réalisateurs s'opposaient aux « maîtres » des studios
          ...
          indépendante.
          <br />
          <br /> Dans le même temps d'autres réalisateurs qui ne sont pas passés
          par les studios se font connaître, comme Susumu Hani et Hiroshi
          Teshigahara, qui débutent en réalisant des documentaires.
          <br />
          <br /> C'est aussi l'essor des productions indépendantes, produites
          ...
          japonaise.
          <br />
          <br /> Alors que la fréquentation totale des salles baisse à partir de
          1959, apparaissent des petites sociétés spécialisées dans la
          production de films érotiques ou pinku-eiga qui attirent un large
          public.
          <br />
          ...
          <br />
          <br /> C'est à cette époque que Kōji Wakamatsu et Masao Adachi
          réalisent l'essentiel de leurs films, croisant les codes du pinku
          eiga, du film de yakuza et la critique sociale virulente.
        </p>
        ...
        <p className='texte'>
          ...
          Cérémonie de Nagisa Ōshima qu'il s'agit d'une synthèse prématurée de
          la démocratie d'après-guerre.
          <br />
          <br /> L'époque est au pessimisme : Yukio Mishima s'est suicidé en
          1970, en 1971 Masao Adachi part pour le Liban, en 1972 l'Armée rouge
          japonaise tourne ses armes contre 12 de ses propres membres, les
          survivants sont ensuite arrêtés à l'issue d'un siège qui bat tous les
          records d'audience à la télévision.
          <br />
          <br /> Pour Nagisa Ōshima, c'est la fin du rôle des jeunes dans
          l'histoire moderne du Japon. Les films de yakuza ont le vent en poupe
          : Kinji Fukasaku filme de jeunes délinquants qui enfreignent toutes
          les règles et par là se condamnent à une mort violente et prématurée
          comme dans Combat sans code d'honneur.
          <br />
          <br /> C'est aussi l'époque des premiers films de la série Otoko wa
          tsurai yo (C'est dur d'être un homme) de Yōji Yamada, saga populaire
          aux thèmes universels.
          <br />
          <br /> En 1972, la police saisit quatre films roman porno (pinku-eiga
          de la Nikkatsu) et neuf personnes sont inculpées. Le genre attire
          néanmoins des créateurs au sommet de leur art.
          <br />
          <br /> C'est dans ce contexte qu'Oshima réalise en 1976, grâce à un
          producteur français, L'empire des sens qui repousse les limites de
          l'expression de la sexualité au Japon. Les livres qui présentent le
          scénario et des photos du film sont saisis par les autorités
          japonaises, le film est censuré et n'est jamais sorti au Japon en
          version intégrale.
        </p>
        <h2>Les années 1980</h2>
        <p className='texte'>
          Les années 1980 et 1990 signent la mort du système des grands studios.
          L'industrie du cinéma se reforme autour de producteurs et de
          réalisateurs indépendants.
          <br />
          <br /> Les cinéastes de l'après-guerre continuent de tourner avec des
        ...
        <p className='texte'>
          Manque de communication, effritement des rapports humains et
          ...
          studios américains.
          <br />
          <br /> Si les films d'horreur occidentaux sont des références pour ces
          réalisateurs, ils développent néanmoins un traitement formel qui
          s'impose comme « histoires de fantômes japonais » ou J-Horror.
          <br />
          <br /> Ces films caractérisés par une « horreur glacée » ne sont pas
          sans être irrigués par la description de l'effacement des liens
          sociaux remplacés par des prothèses électroniques.
          <br />
          <br /> Dans cette optique, Shin'ya Tsukamoto peut être considéré comme
          le précurseur thématique, mais pas formel, de ce genre avec Tetsuo
          (1989), bien que Kurosawa indique que plusieurs de ses scénarios
          d'horreurs ont été refusés depuis les années 1980.
          <br />
          <br /> Le cinéma japonais aborde à cette époque des thèmes qui sont en
          passe de devenir internationaux dans les années 2000, avec le
          développement et la démocratisation de ce qu'on appelle alors les NTIC
          pour Nouvelles Technologies de l'Information et de la Communication
          (images numériques, ordinateurs personnels, téléphones portables et
          Internet).
        </p>
        <h2>Les années 2000</h2>
        <p className='texte'>
          Hirokazu Kore-eda, Shinji Aoyama, Nobuhiro Suwa produisent des œuvres
          influencées par le professeur spécialiste de littérature et de
          philosophie française Shigehiko Hasumi, et continuent à dépeindre la
          famille japonaise comme lieu d'expression privilégié des
          bouleversements de la société dans son ensemble.
          <br />
          <br /> Kiyoshi Kurosawa, élève d'Hasumi comme Aoyama mais plus vieux
          peut également être inscrit dans ce mouvement malgré les quelques
          ...
          <br />
          <br /> Au tournant des années 2010, c'est Kōji Wakamatsu qui revient à
          la réalisation pour quatre films.
          <br />
          <br /> Il meurt en 2012, renversé par un taxi juste après avoir
          annoncé sa volonté de réaliser un film sur l'entreprise Tepco et
